...
import {
  ...
  fetchCachepcontent,
  uploadDataWithImage,
} from "../../features/cachepcontentSlice";

const Cachepcontent: React.FC = () => {
  const dispatch = useAppDispatch();
  const { cachepcontent, loading, error } = useAppSelector(
    (state) => state.cachepcontent
  );
    ...
    <Layout>
      <div className="app-container">
        <div className="form-container">
          <div>
            <h2 className="form-heading">Content Cá chép nhào lộn</h2>
          </div>
          <form className="mt-8 space-y-6" onSubmit={handleUpload}>
            ...
            <div>
              <button
                type="submit"
                disabled={!banner || !title || !description || !mota}
                className="button"
              >
                Add New
              </button>
