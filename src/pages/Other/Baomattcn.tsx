...
import {
  ...
  fetchThongtincanhan,
  uploadDataWithImage,
} from "../../features/thongtincanhanSlice";
    ...
    <Layout>
      <div className="app-container">
        <div className="form-container">
          <div>
            <h2 className="form-heading">Thông tin cá nhân - Bảo mật</h2>
          </div>
        ...
        <div className="table-container">
          <h2 className="table-heading">Thông tin cá nhân - Bảo mật</h2>
